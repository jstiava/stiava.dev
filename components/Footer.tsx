...
export default function Footer() {
    ...
    return (
        <div className={cn(
            "flex flex-col w-full h-fit min-h-[40vh] bg-border mt-16",
            "md:flex-row"
        )}>
            <div className={cn(
                "flex flex-col p-12 gap-2 w-full",
                "md:w-[60%]"
            )}>
